...
namespace GetData
{
    ...
    {
        public AvalancheRegionForecast()
        {
        ...
        public string Day3DangerElevationHigh { get; set; }
        public string Day3DangerElevationMiddle { get; set; }
        public string Day3DangerElevationLow { get; set; }
        ...
        public string ToString(out StringBuilder sbHeader)
        {
            ...
            sbHeader.Append("Day3DangerAboveTreeline, Day3DangerNearTreeline, Day3DangerBelowTreeline, ");

            var sbBody = new StringBuilder();
            sbBody.Append(Utilities.CleanStringForCSVExport(Zone) + ",");
            ...
            sbBody.Append(Day3DangerElevationHigh + ",");
            sbBody.Append(Day3DangerElevationMiddle + ",");
            sbBody.Append(Day3DangerElevationLow + ",");
            ...
            ExtractAvalancheProblem("Persistent Slabs", sbHeader, sbBody);
            ExtractAvalancheProblem("Deep Persistent Slabs", sbHeader, sbBody); //TODO: need to check this is actually what NWAC uses
            ExtractAvalancheProblem("Storm Slabs", sbHeader, sbBody);
            ExtractAvalancheProblem("Wet Slabs", sbHeader, sbBody);
            ExtractAvalancheProblem("Wind Slabs", sbHeader, sbBody);
