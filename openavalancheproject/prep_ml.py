...
class PrepML:
    ...
    def __init__(self, data_root, output_root = None, nc_root = None, interpolate=1, resample_length='1d', date_start='2015-11-01', date_end='2021-04-30', date_train_test_cutoff='2020-11-01'):
        """
        ...
        self.nc_path = self.nc_root + '/3.GFSFiltered'+ str(self.interpolation) + 'xInterpolation' + resample_length + '/'
        self.processed_path = data_root + '/4.GFSFiltered'+ str(self.interpolation) + 'xInterpolationZarr' + resample_length + '/'
        self.path_to_labels = data_root + 'CleanedForecastsNWAC_CAIC_UAC_CAC.V1.2013-2021.csv'
        self.ml_path = self.output_root + '/5.MLData'
